  ...
  return (
    <div className={styles.container}>
      <div className={styles.name}>
        <p className={classnames(fonts.mediumText, styles.firstName)}>AARON</p>
        <p className={classnames(fonts.largeText, styles.lastName)}>FLOWER</p>
        <p className={classnames(styles.occupation, fonts.mediumTextBold)}>Javascript Developer</p>
        ...
        <a href={require("../../base/assets/AaronFlowerResume.pdf")} download="AaronFlowerResume.pdf">
          <button className={classnames(styles.spacer, fonts.smallText, styles.btn)}>Resume</button>
        </a>
      </div>
    </div>
  )
